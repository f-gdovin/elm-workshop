...
searchFeed query =
    ...
    in
        request
         |> Http.send(\request -> HandleSearchResponse(request))
...
type Msg
    ...
    | SetQuery String
    | DeleteById Int
    | HandleSearchResponse (Result Http.Error (List SearchResult))  --Result Err = Http.Error, Result OK = List<SearchResult>
